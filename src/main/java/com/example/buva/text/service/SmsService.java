...
public class SmsService {
	...
	private String secretKey;
	 ...
	 public SMSResp sendSMS(String to, String content) throws JsonProcessingException, InvalidKeyException, IllegalStateException, UnsupportedEncodingException, NoSuchAlgorithmException{
        ...
        SMSReq smsRequest = new SMSReq("SMS", "COMM","82", "01073656042", "여기는 내용", new MessageDto(to, content));
